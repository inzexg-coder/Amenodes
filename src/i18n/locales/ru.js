export const ru = {
  ...
  // Добавить в существующий объект ru:
  ...
  nodeDescriptions: {
    ...
    group: 'Коллекция именованных числовых значений',
    calc: 'Узел расчёта погрешности (измерение, округление, суммарная)',
    output: 'Отображает результаты подключённых узлов в таблице',
