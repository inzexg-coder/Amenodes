export const ru = {
  ...
  editor: {
    ...
    cursorStyleDesc: 'Кастомный курсор при перетаскивании связи',
    cursorSize: 'Размер курсора',
    cursorEffect: 'Эффект курсора',
    cursorEffectNone: 'Нет',
    cursorEffectGlow: 'Свечение',
    visualLabel: 'Визуал',
    interactionLabel: 'Управление',
    cursorSection: 'Курсор соединения',
    cursorSizeDesc: 'Диаметр курсора в пикселях',
    cursorEffectDesc: 'Свечение вокруг кастомного курсора',
    premium: 'premium',
