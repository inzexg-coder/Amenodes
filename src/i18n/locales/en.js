export const en = {
  ...
  optimizations: {
    ...
    animSpeedDesc: "Affects node movement and appearance",
    animSpeedPros: "Customizable to taste",
    animSpeedCons: "Fast = janky, slow = edges lag",
    fpsGain: 'FPS gain',
  ...
  editor: {
    ...
    cursorStyleDesc: 'Custom cursor while dragging a connection',
    cursorSize: 'Cursor Size',
    cursorEffect: 'Cursor Effect',
    cursorEffectNone: 'None',
    cursorEffectGlow: 'Glow',
    visualLabel: 'Visual',
    interactionLabel: 'Interaction',
    cursorSection: 'Connection Cursor',
    cursorSizeDesc: 'Cursor diameter in pixels',
    cursorEffectDesc: 'Glow effect around the cursor',
    premium: 'premium',
