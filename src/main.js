...
function refreshPremiumTheme() {
    var isPrem = localStorage.getItem('amenodes_premium') === 'true';
    var isPurple = isPrem && localStorage.getItem('premium_purple_accent') === 'true';
    document.body.classList.toggle('premium-purple', isPurple);
    document.body.classList.toggle('premium-hover', isPurple);
    var edgeWave = isPrem && localStorage.getItem('premium_edge_wave') === 'true';
...
(function() {
    if (localStorage.getItem('amenodes_premium') === 'true' && localStorage.getItem('premium_purple_accent') === 'true') {
...
class Application {
  ...
  initRenderer() {
    ...
    this.renderer.inertiaEnabled = () => {
      if (localStorage.getItem('amenodes_premium') !== 'true') return false;
      return localStorage.getItem('premium_overshoot_bounce') === 'true';
    };
